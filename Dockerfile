# Multi-Stage Dockerfile for Spring Boot Application (notification-service)
...
# --- CONFIGURE MAVEN for GitHub Packages Repository (GPR) ---
# Create a temporary settings.xml file to hold the GPR credentials.
# This is necessary for Maven to resolve the 'my-learn-common' dependency.
RUN mkdir -p /root/.m2 \
...
# Expose the application port (The notification-service runs on 8083 locally)
EXPOSE 8083
